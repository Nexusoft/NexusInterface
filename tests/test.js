  ...
  afterEach(function() {
    ...
    if (this.currentTest.state == 'failed') {
      ...
      this.app.browserWindow.capturePage().then(function (imageBuffer) {
        let fs = require("fs");
        fs.writeFile('Nexus_Fail_Test_' + testTitle + '.png', imageBuffer, function () {} );
      })
    }
  });
...
describe("Run Page Tests", function() {
  ...
  it("Change Fiat Settings", function() {
    return appRef.client
      ...
      .element("#navigation").element('a[href^="#/Settings"]').click()
      .pause(500)
      .element("#fiatSelector").selectByValue("USD");
  });
