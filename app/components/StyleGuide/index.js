			...
			<div className="panel">
				...
				<div className="grid-container">
					...
					<section id="colors">
						...
						<label className="toggle" htmlFor="toggle-colors"></label>

						<div className="panel">

							<ul>

								<li><div className="swatch"></div></li>
				...
				`}
					...
					<section id="headers">
						...
						<label className="toggle" htmlFor="toggle-headers"></label>
				...
				`}		</code></pre>	
					...
					<section id="block-text">
						...
						<input type="checkbox" className="toggle" id="toggle-block-text"/>
						<label className="toggle" htmlFor="toggle-block-text"></label>
				...
				&lt;/p&gt;
					...
					<section id="inline-text">
						...
						<input type="checkbox" className="toggle" id="toggle-inline-text"/>
						<label className="toggle" htmlFor="toggle-inline-text"></label>
						...
						<div className="panel">
							...
							<div className="example">
								...
								<p className="fifty-percent">
									...
									<abbr title="abbreviation title">abbreviation</abbr><br/>
									<b>bold text</b><br/>
									<cite>citation</cite><br/>
									<code>.code {`{color: red;}`}</code><br/>
									<del>deleted text</del><br/>
									<dfn title="definition term title">definition term</dfn><br/>
								...
								<p className="fifty-percent">
									...
									<q>short <q>quotation</q>
									inside of another quotation</q><br/>
									<s>incorrect text</s><br/>
				...
				&lt;p&gt;
					...
					&lt;code&gt;.code {`{color: red;}`}&lt;/code&gt;&lt;br&gt;
					&lt;del&gt;deleted text&lt;/del&gt;&lt;br&gt;
					&lt;dfn title="definition term title"&gt;
						definition term
					&lt;/dfn&gt;&lt;br&gt;
					&lt;em&gt;emphasisted text&lt;/em&gt;&lt;br&gt;
					&lt;i&gt;alternate voice&lt;/i&gt;&lt;br&gt;
				...
				&lt;/p&gt;
					...
					<section id="preformatted">
						...
						<input type="checkbox" className="toggle" id="toggle-preformatted-text"/>
						<label className="toggle" htmlFor="toggle-preformatted-text"></label>
				...
				&lt;/code&gt;&lt;/pre&gt;
					...
					<section id="blockquotes">
						...
						<input type="checkbox" className="toggle" id="toggle-blockquotes"/>
						<label className="toggle" htmlFor="toggle-blockquotes"></label>
						...
						<pre className="code-example"><code>
				&lt;p&gt;
					A quick quote from lorem ipsum:
				&lt;/p&gt;
				&lt;blockquote&gt;
				Lorem ipsum ...
				&lt;/blockquote&gt;
				&lt;p&gt;
					Now that we're done with that lets move on.
				&lt;/p&gt;
						</code></pre>
					...
					<section id="unordered-list">
						...
						<input type="checkbox" className="toggle" id="toggle-unordered-list"/>
						<label className="toggle" htmlFor="toggle-unordered-list"></label>
				...
				&lt;/ul&gt;
					...
					<section id="ordered-list">
						...
						<input type="checkbox" className="toggle" id="toggle-ordered-list"/>
						<label className="toggle" htmlFor="toggle-ordered-list"></label>
				...
				&lt;/ol&gt;
					...
					<section id="definition-list">
						...
						<input type="checkbox" className="toggle" id="toggle-definition-list"/>
						<label className="toggle" htmlFor="toggle-definition-list"></label>
				...
				&lt;/dl&gt;
					...
					<section id="table">
						...
						<label className="toggle" htmlFor="toggle-table"></label>
						...
						<pre className="code-example"><code>
				&lt;table class="bordered padded striped"&gt;
				...
				&lt;/table&gt;
					...
					<section id="forms-default">
						...
						<input type="checkbox" className="toggle" id="toggle-forms-default"/>
						<label className="toggle" htmlFor="toggle-forms-default"></label>
								...
								<form>
									...
									<fieldset>
										...
										<div className="field">
											...
											<span className="hint">Email address is required and must be in the format: user@@domain.com</span>
										</div>
									...
									<p>
										<input type="submit" className="button primary" /> <input type="reset" value="Reset" className="button" />
									</p>
				...
				&lt;/form&gt;
					...
					<section id="forms-inline">
						...
						<input type="checkbox" className="toggle" id="toggle-forms-inline"/>
						<label className="toggle" htmlFor="toggle-forms-inline"></label>
				...
				&lt;/form&gt;
					...
					<section id="forms-aligned">
						...
						<input type="checkbox" className="toggle" id="toggle-forms-aligned"/>
						<label className="toggle" htmlFor="toggle-forms-aligned"></label>
				...
				&lt;/form&gt;
					...
					<section id="buttons">
						...
						<label className="toggle" htmlFor="toggle-buttons"></label>
				...
				&lt;button class="button ghost"&gt;Ghost&lt;/button&gt;
					...
					<section id="button-sizes">
						...
						<input type="checkbox" className="toggle" id="toggle-button-sizes"/>
						<label className="toggle" htmlFor="toggle-button-sizes"></label>
				...
				&lt;button class="button small"&gt;Small&lt;/button&gt;
					...
					<section id="switches">
						...
						<label className="toggle" htmlFor="toggle-switches"></label>
							...
							<div className="example">
								...
								<form className="aligned">
									...
									<div className="field">
										...
										<input type="checkbox" className="switch" defaultChecked disabled/>
									</div>
