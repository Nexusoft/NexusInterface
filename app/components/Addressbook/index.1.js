...
class Addressbook extends Component {
  ...
  processaccounts()
  {
    ...
    const namesContainer = document.getElementById("addressbook-contacts");
  ...
  contactdetailer(accountDisplayDiv, name, phone, timeZone, notes, notFirst)
  {
    ...
    const contactDetailContainer = document.getElementById("addressbook-details");
