...
(function() {
    ...
    TradingView.chart.prototype = {
        ...
        renderCss: function() {
            ...
            //TODO: get css tweaked to flow with the rest of the divs in overview page
            ...
            .tradingview-widget .chart-actions-float {
                display: none;
                 position: absolute;
                 z-index: 5;
                 top: 0;
            ...
            .chart-actions-float a:nth-child(1) {
                border-right: 1px solid #b2b5b8;
            }
            .chart-actions-float a:nth-child(2) {
                padding: 5px 10px 5px 5px;
            }
            .tradingview-widget .chart-actions-float .status-picture {
                margin: 4px 1px 0 3px;
                 border: none !important;
                 padding: 0 !important;
                 background: none !important;
            }
            .tradingview-widget .chart-status-picture {
                position: absolute;
                 z-index: 50;
            }
            .tradingview-widget .icon {
                display: inline-block;
                 position: relative;
            }
            .tradingview-widget .icon-action-realtime{
                background: url('" + url + "/static/images/svg/chart/make-it-live.svg');
                 width: 28px;
                 height: 28px;
                 margin-right: 2px;
            }
            .tradingview-widget .icon-action-zoom{
                background: url('" + url + "/static/images/svg/chart/fullscreen-embed.svg');
                 width: 28px;
                 height: 28px;
            }
            .tradingview-widget .exit-fullscreen {
                z-index: 16;
                 position: fixed;
                 top: -1px;
                 left: 50%;
            ...
            .tradingview-widget .exit-fullscreen:hover {
                opacity: 1;
            }
            .tradingview-widget .tradingview-button {
                padding: 5px;
                ...
                color: #4c525e;
                 cursor: pointer;
                 font: normal 14px TrebuchetMS, Calibri, Arial;
            ...
            .tradingview-widget .tradingview-button:hover, ._tv-button:active {
